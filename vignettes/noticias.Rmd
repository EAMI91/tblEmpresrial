...
X <- sample(c("Buena", "Mala", "Regular"),prob = c(.2,.2 ,.6), n, replace=T) 
...
base1 <- BD %>% 
         ...
         mutate(color=if_else(mencionGenerada=="Boletines\n de prensa", "#0f4c42", 
                      if_else(mencionGenerada=="declaraciones","#cb2833","#808080")),                 
                      id= if_else(mencionGenerada=="Boletines\n de prensa", "bp", 
                      if_else(mencionGenerada=="declaraciones","dec","filtraciones")))%>%
...
base2 <- BD %>% 
        ...
        rename("name"= "mencionGenerada", "value"="n", "parent"= "percepcion")
